...
def main():
    ...
    # Lade die Daten
    file_with_anomalies = "id118neu/filtered_data_118.csv"  # Pfad zur Datei mit Anomalien
    file_with_imputations = "id118neu/imputed_meter_readings_118_CPI.csv"  # Pfad zur Datei mit imputierten Anomalien
