...
df = pd.read_csv("id335/Daten/imputed_meter_readings_335_CPI.csv", parse_dates=["timestamp"])
...
plt.savefig(f"Forecast/forecast_plot_simple_id{building_id},ohne,CPI,{timestamp}.png")
plt.show()

forecast_df = forecast.pd_dataframe()
forecast_df.to_csv(f"Forecast/forecast_data_id{building_id},ohne,CPI,{timestamp},48h.csv", index=True)
