...
plt.savefig(f"Forecast/forecast_plot_simple_id{building_id},mit,{timestamp}.png")
plt.show()

forecast_df = forecast.pd_dataframe()
forecast_df.to_csv(f"Forecast/forecast_data_id{building_id},mit,{timestamp}.csv", index=True)
